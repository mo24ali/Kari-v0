        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <?php if ($authService->isAuth()): ?>
                    ...
                    <?php if ($authService->getUserRole() === 'host' || $authService->getUserRole() === 'admin'): ?>
            ...
            <div class="flex items-center space-x-4">
                ...
                <?php else: ?>
                    <div class="flex items-center space-x-3">
                        <a href="/login" class="text-sm font-semibold hover:text-primary transition-colors">Connexion</a>
                        <a href="/signup"
                            class="px-5 py-2 bg-primary text-white text-sm font-black rounded-xl hover:bg-primary-dark shadow-lg shadow-primary/20 transition-all active:scale-95">
                            Inscription
                        </a>
                    </div>
                <?php endif; ?>
