        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="/reservations" class="text-sm font-medium hover:text-primary transition-colors">Réservations</a>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="/hote" class="hidden md:block px-4 py-2 bg-surface text-sm font-medium rounded-lg border border-light hover-lift">
                        Devenir hôte
                    </a>
                    ...
                    <div class="relative">
                        <button id="user-menu-btn" class="flex items-center space-x-2 p-1 rounded-lg hover:bg-surface transition-colors">
                            <a href="/profile" class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-xs font-medium hover:opacity-80 transition-opacity">
                        ...
                        <div id="user-menu" class="absolute right-0 mt-2 w-56 bg-surface rounded-lg shadow-custom-lg border border-light hidden">
                            ...
                            <div class="p-2">
                                <a href="/profile" class="flex items-center px-3 py-2 rounded hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
                                ...
                                <a href="/favoris" class="flex items-center px-3 py-2 rounded hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
                                    <i class="fas fa-heart mr-3 text-secondary"></i>
                                    <span>Favoris</span>
                                </a>
                                <a href="/reservations" class="flex items-center px-3 py-2 rounded hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">
                                    <i class="fas fa-receipt mr-3 text-secondary"></i>
                                    <span>Réservations</span>
                                </a>
                                <div class="border-t border-light my-2"></div>
                                <a href="/logout" class="flex items-center px-3 py-2 rounded hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-red-600">
