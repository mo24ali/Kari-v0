            ...
            <div class="bg-surface rounded-lg shadow-custom-lg border border-light p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-primary"><?php echo number_format($stats['total_users']); ?>
                        </p>
                    </div>
                    <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-primary">
                            <?php echo number_format($stats['total_logements']); ?>
                        </p>
                    </div>
                    <div
            ...
            <div class="bg-surface rounded-lg shadow-custom-lg border border-light p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-primary"><?php echo number_format($stats['total_reviews']); ?>
                        </p>
                    </div>
                    <div
                        class="w-12 h-12 rounded-full bg-yellow-100 dark:bg-yellow-900/20 flex items-center justify-center">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span
                                class="text-sm text-secondary"><?php echo $stats['users_by_role']['traveller']; ?></span>
                        </div>
                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        ...
                        <?php foreach ($recentLogements as $logement): ?>
                            <div
                                ...
                                <div class="flex items-center flex-1">
                                    ...
                                    <?php else: ?>
                                        <div
                                            class="w-16 h-16 rounded-lg bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center mr-3">
                                            <i class="fas fa-home text-white"></i>
                                        </div>
                                    <?php endif; ?>
                                    <div class="flex-1">
                                        <a href="/logement/details?id=<?php echo $logement->getId(); ?>"
                                            class="hover:underline">
                                            <p class="font-medium">Logement #<?php echo htmlspecialchars($logement->getId()); ?>
                                            </p>
                                        </a>
                                        ...
                                        <p class="text-sm font-bold text-primary mt-1">
                                            <?php echo number_format($logement->getPrice(), 2); ?>€ /nuit
                                        </p>
                                    </div>
                                </div>
                            </div>
